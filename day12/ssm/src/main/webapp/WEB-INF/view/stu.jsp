...
<body class="gray-bg">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<td>爱好：</td>
								<td>
									...
									<input type="checkbox" name="sdhobby" id="sdhobby3" value="睡觉" >睡觉
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>生日：</td>
								<td>
									<input readonly="readonly" placeholder="请输入时间" id="sdbirth" name="sdbirth" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>角色：</td>
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addMajor" method="post" action="addMajor.htm">
						<input type="text" name="mdname" class="form-control" aria-required="true" required/>
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addMajor">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_addMajor").click(function(){
	...
	function initEditUser(getSelection){
		...
		$('#sdhobby3').prop("checked",getSelection.sdhobby.indexOf("睡觉")!=-1);
	}
