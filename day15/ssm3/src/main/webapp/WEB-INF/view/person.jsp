...
<body class="gray-bg">
			 ...
			 <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">时间 </span>
                     <input placeholder="请输入时间"id="txt_search_end" name="createtime" class="laydate-icon form-control layer-date"/>
				</div>
			  </div>
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td><input type="checkbox" id="pLike1" name="pLike"
									...
									value="睡觉" aria-required="true" required/>睡觉</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款人性别：</td>
							...
							<tr>
								...
								<td>存款人日期：</td>
								<td>
									 <input readonly="readonly" placeholder="开始时间" id="txt_search_start" name="createtime" class="laydate-icon form-control layer-date"/>
	...
	function initEditUser(getSelection){
		...
		$('#pLike1').prop("checked",getSelection.pLike.indexOf("足球")!=-1);
		$('#pLike2').prop("checked",getSelection.pLike.indexOf("篮球")!=-1);
		$('#pLike3').prop("checked",getSelection.pLike.indexOf("睡觉")!=-1);
