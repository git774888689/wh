...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>密码：</td>
								<td>
				                     <input readonly="readonly" placeholder="请输入时间" id="txt_search_start" name="createTime" class="laydate-icon form-control layer-date"/>
								</td>
							</tr>
							<tr>
								<td>性别：</td>
								...
								<td>特点：</td>
								<td>
									<input type="checkbox" id="expressTrait1" name="expressTrait" value="帅气">帅气
									<input type="checkbox" id="expressTrait2" name="expressTrait" value="能干">能干
									<input type="checkbox" id="expressTrait3" name="expressTrait" value="骚气">骚气
								</td>
							</tr>
							<tr>
								<td>快递公司：</td>
	...
	var TableInit = function () {
	    ...
	    oTableInit.Init = function () {
	        $('#table_user').bootstrapTable({
	            url: 'expressPersonList.htm',         //请求后台的URL（*）
	            method: 'post',                      //请求方式（*）
	...
	function initEditUser(getSelection){
		...
		$('#txt_search_start').val(new Date(getSelection.createTime).Format("yyyy-MM-dd"));
		$('#expressTypeId').val(getSelection.expressTypeId);
		$('#expressTrait1').prop("checked",getSelection.expressTrait.indexOf("帅气")!=-1);
		$('#expressTrait2').prop("checked",getSelection.expressTrait.indexOf("能干")!=-1);
		$('#expressTrait3').prop("checked",getSelection.expressTrait.indexOf("骚气")!=-1);
